...
var _get = function t(e, i, n) {
  ...
  window.cash = function () {
	...
	}); var X = o.documentElement; return y.extend({
	  position: function () {
		var t = this[0];
		return {
		  left: t.offsetLeft,
  ...
  'function' == typeof define && define.amd ? define('M', [
	...
	function b(t, e) {
	  for (var i = t.length, n = 2 <= arguments.length ? e : void 0, s = [
	  ], o = 0; o < i; o++) if (o in t) {
		var a = t[o];
	...
	function o(t) {
	  return B.arr(t) ? t : (B.str(t) && (t = s(t) || t), t instanceof NodeList || t instanceof HTMLCollection ? [
	  ].slice.call(t)  : [
		t
	  ])
	}
	...
	function O(t) {
	  ...
	  function c(e) {
		for (var t = 0, i = {
		  ...
		  for (var r = Math.min(Math.max(e - h.start - h.delay, 0), h.duration) / h.duration, d = isNaN(r) ? 1 : h.easing(r, h.elasticity), r = h.to.strings, u = h.round, l = [
	  ...
	  _createClass(n, [
		...
		},
		{
		  ...
		  value: function (t) {
			...
			this.$overlay[0].style.zIndex = 1000 + 2 * n._modalsOpen,
			this.el.style.zIndex = 1000 + 2 * n._modalsOpen + 1,
			...
			this.el.parentElement.parentElement.insertBefore(this.$overlay[0], this.el.parentElement.nextSibling),
	  ...
	  _createClass(n, [
		...
		},
		{
		  ...
		  value: function () {
			...
			this.newWidth = 0,
			this.newHeight = 0,
			s < n ? (i = this.originalHeight / this.originalWidth, this.newWidth = 0.9 * this.windowWidth, this.newHeight = 0.9 * this.windowWidth * i)  : (i = this.originalWidth / this.originalHeight, this.newWidth = 0.9 * this.windowHeight * i, this.newHeight = 0.9 * this.windowHeight),
	  ...
	  _createClass(B, [
		...
		},
		{
		  ...
		  value: function (t, e, i, n, s, o) {
			...
			m = !0;
			for (d = [
			], l = 0; l < 12; l++) d.push('<option value="' + (i === s ? l - e : 12 + l - e) + '"' + (l === n ? ' selected="selected"' : '') + (c && l < u.minMonth || p && l > u.maxMonth ? 'disabled="disabled"' : '') + '>' + u.i18n.months[l] + '</option>');
			...
			]; l < h && l <= u.maxYear; l++) l >= u.minYear && d.push('<option value="' + l + '" ' + (l === i ? 'selected="selected"' : '') + '>' + l + '</option>');
